...
This work was developed as the final degree project for the BSc in Data Science and Engineering at Universitat Politècnica de Catalunya (UPC), Barcelona, and forms part of ongoing research. The complete thesis report is available in the repository: [`report.pdf`](report.pdf)
